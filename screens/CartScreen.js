...
const CartScreen = () => {
  ...
  const handleRequest = async () => {
    // Assuming you have an ID to be passed in the request URL
    const userId = "your_user_id"; // Replace this with your actual user ID

    // URL for the POST request
    const requestUrl = `https://digital-garage.onrender.com/addServiceRequest`;
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Perform any additional actions or navigate to a different screen
      } else {
        // Handle error
    ...
    <>
      ...
      {total === 0 ? null : (
        ...
        >
          ...
          >
            <Text style={{color:"white",fontSize:16,fontWeight:"bold",textAlign:"center"}}>Request</Text>
          </Pressable>
        </Pressable>
      )}
    </>
